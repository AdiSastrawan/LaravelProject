                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="{{ url('packages') }}"
                                    class="inline-flex items-center text-lg font-semibold text-gray-600 hover:text-gray-900">
                                    Packages
                                </a>
                            </li>
                            <li>
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ url('cart') }}"
                                        class="ml-1 text-lg font-medium text-gray-500 md:ml-2">
                                        Cart
                                    </a>
                                </div>
                            </li>
                ...
                @foreach ($packages as $key => $item)
                    <div
                        ...
                        <div class="sm:p-2 sm:pl-0 sm:w-4/6">
                            <span class="mt-4 mb-2 inline-block font-medium text-red-600 sm:mt-0">
                                4 rooms left
                            </span>
                            ...
                            <div class="flex flex-row space-x-3">
                                <div
                                    ...
                                    {{ 'Rp ' . number_format($item->prices['monthly_price'], 2, ',', '.') }}<span
