            ...
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="flex flex-row mb-1 sm:mb-0">
                    <div class="relative flex items-center ">
                        ...
                        <a class="hover:bg-green-800 py-2 px-3 mx-2   rounded-l border block  w-full  border-white text-white leading-tight bg-green-500 rounded-md "
                        ...
                        <tbody>
                            @foreach ($package as $p)
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <img class="w-40 h-40 bg-cover" src="{{ asset('img') }}/{{ $p->feature_img }}"
                                            alt="">
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex flex-wrap ">
                                            ...
                                            <form action="{{ route('package.destroy', ['package' => $p->package_id]) }}"
