                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr>
                                ...
                                <td class=" text-left py-3 px-4">{{"Rp " .
                                    number_format($p->prices['monthly_price'],2,',','.');}}</td>
                                <td class=" text-left py-3 px-4"><img class="w-40 h-40"
                                        src="{{asset('img')}}/{{$p->feature_img}}" alt=""></td>

                                <td class="text-left py-3 px-4">
                                    <div class="flex flex-wrap ">
                                        <a class="hover:bg-blue-800 py-2 px-3 m-2 border-white text-white bg-blue-500 rounded-md "
                                            href="{{route('admin-package-edit',['id'=>$p->package_id])}}">edit</a> <a
                                            class="hover:bg-red-800 py-2 px-3 border-white text-white m-2 bg-red-500 rounded-md "
                                            href="{{route('admin-package-destroy',['id'=>$p->package_id])}}">delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
